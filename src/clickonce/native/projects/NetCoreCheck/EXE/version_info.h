...
#define VER_BUILD_MAJOR             1
#define VER_BUILD_MINOR             1
...
#define VER_PRODUCTNAME_STR         "Microsoft NetCoreCheck"
#define VER_FILEDESCRIPTION_STR     "Microsoft .NET Core checker tool"

#ifdef VER_INTERNALNAME_STR
#undef  VER_INTERNALNAME_STR
#endif
#define VER_INTERNALNAME_STR        "NetCoreCheck.exe"
#define VER_ORIGINALFILENAME_STR    "NetCoreCheck.exe"
